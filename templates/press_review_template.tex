...
# Contenu du template LaTeX avec mise en page complète
template_content = r"""
...
# Enregistrer le template dans le fichier
with open("templates/press_review_template.tex", "w", encoding="utf-8") as f:
    f.write(template_content)

print("✅ Nouveau template LaTeX enregistré dans templates/press_review_template.tex")
