# Script corrigé pour écrire une seule fois le template LaTeX dans le fichier

# Définition du contenu du template LaTeX
latex_template = r"""
...
# Écriture du template dans le fichier press_review_template.tex
